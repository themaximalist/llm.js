...
fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-001:generateContent", {
  "headers": {
    ...
    "x-goog-api-client": "google-genai-sdk/1.4.0 gl-node/web",
    "x-goog-api-key": "AIzaSyA2rAmtO-QoWllNfLueYoCwbpngD9uWOB8"
  },
  "referrer": "http://localhost:63315/",
  "referrerPolicy": "strict-origin-when-cross-origin",
  "body": "{\"contents\":[{\"parts\":[{\"text\":\"Why is the sky blue?\"}],\"role\":\"user\"}]}",
  "method": "POST",
  "mode": "cors",
  "credentials": "omit"
});
